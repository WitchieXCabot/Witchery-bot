...
config: {
    name: 'dadjoke',
    category: "fun",
    aliases: ['dadj', 'dad', 'djoke', 'dj'],
    description: "Send a random dad joke from database",
},
run: async (bot, message, args) => {
    var jokes = [
        ...
        .setFooter(`dad...? | Shhh: This is a secret command`, message.author.displayAvatarURL({ format: "png", dynamic: true }))
